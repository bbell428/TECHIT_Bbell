...
class MemoListViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private lazy var memoTableView: UITableView = {
        ...
        tableView.delegate = self // 셀 선택을 위해 사용
    ...
    private lazy var addButton: UIButton = {
        ...
        button.addAction(UIAction { _ in
            print("Hello")
            let modalViewController = AddingMemoViewController()
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        //화면 전환
        let nextViewController: MemoDetailViewController = .init()
        nextViewController.setMessage(memoStore.memoList[indexPath.row].text)
