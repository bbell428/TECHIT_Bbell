...
class EuropeViewController: CommonViewController {
    ...
    private lazy var koreaButton: UIButton = setGreetingButton(title: "GREECE", tag: 0)
    private lazy var japanButton: UIButton = setGreetingButton(title: "FRANCE", tag: 1)
    private lazy var chinaButton: UIButton = setGreetingButton(title: "FINLAND", tag: 2)
    ...
    private func setGreeting(tag: Int) {
        switch tag {
        case 0:
            greetingLabel.text = "γεια σας"
        case 1:
            greetingLabel.text = "Bon jour"
        default:
            greetingLabel.text = "Moi"
        }
    }
