...
class AfricaViewController: CommonViewController {
    ...
    private lazy var koreaButton: UIButton = setGreetingButton(title: "EGYPT", tag: 0)
    private lazy var japanButton: UIButton = setGreetingButton(title: "NIGERIA", tag: 1)
    private lazy var chinaButton: UIButton = setGreetingButton(title: "ETHIOPIA", tag: 2)
    ...
    private func setGreeting(tag: Int) {
        switch tag {
        case 0:
            greetingLabel.text = "Assalamalaicum"
        case 1:
            greetingLabel.text = "Bawo ni"
        default:
            greetingLabel.text = "Selam"
        }
    }
